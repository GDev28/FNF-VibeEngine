...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var rankText:FlxText = new FlxText(0, 20);
		...
		var bgYellow:FlxSprite = new FlxSprite(0, 75).makeGraphic(FlxG.width, 386, 0xFFF9CF51);
		bgSprite = new FlxSprite(0, 75);
		bgSprite.antialiasing = ClientPrefs.globalAntialiasing;

		grpWeekText = new FlxTypedGroup<MenuItem>();
		add(grpWeekText);

		var blackBarThingie:FlxSprite = new FlxSprite().makeGraphic(FlxG.width, 75, FlxColor.BLACK);
		add(blackBarThingie);
	...
	function changeDifficulty(change:Int = 0):Void
	{
		...
		if(newImagePath != lastImagePath)
		{
			...
			sprDifficulty.y = 5;
			sprDifficulty.scale.x = 0.75;
			sprDifficulty.scale.y = 0.75;

			if(tweenDifficulty != null) tweenDifficulty.cancel();
			tweenDifficulty = FlxTween.tween(sprDifficulty, {y: 0 + 5, alpha: 1}, 0.07, {onComplete: function(twn:FlxTween)
			{
